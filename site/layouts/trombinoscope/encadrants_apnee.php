 ...
 *   `fonction` porte le libellé du meilleur brevet FFESSM "Apnée / encadrant" (ex : "Moniteur entraîneur Fédéral Apnée 1er degré").
 */
...
<div class="gda-trombi-header text-center mb-4">
    <h2 class="fw-bold mb-2 text-white"><?= Text::_('COM_GDA_TROMBINOSCOPE_ENCADRANTS_APNEE_TITLE') ?></h2>
</div>

<?php if (empty($membres)) : ?>
    <p class="gda-trombi-empty text-center py-5 mb-0"><?= Text::_('COM_GDA_TROMBINOSCOPE_ENCADRANTS_APNEE_EMPTY') ?></p>
<?php else : ?>
