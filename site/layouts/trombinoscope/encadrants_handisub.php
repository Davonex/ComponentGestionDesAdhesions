 ...
 *   `fonction` porte le libellé du meilleur brevet FFESSM "Handisub / encadrant" (ex : "EH2 - Scaphandre").
 */
...
<div class="gda-trombi-header text-center mb-4">
    <h2 class="fw-bold mb-2 text-white"><?= Text::_('COM_GDA_TROMBINOSCOPE_ENCADRANTS_HANDISUB_TITLE') ?></h2>
</div>

<?php if (empty($membres)) : ?>
    <p class="gda-trombi-empty text-center py-5 mb-0"><?= Text::_('COM_GDA_TROMBINOSCOPE_ENCADRANTS_HANDISUB_EMPTY') ?></p>
<?php else : ?>
