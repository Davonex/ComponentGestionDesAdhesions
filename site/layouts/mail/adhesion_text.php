...
// Avertissement "Licence seule" (meme texte que la popup au moment du choix et l'encadre du recap)
if ($isLicenceSeule) {
    echo Text::_('COM_GDA_ADHESION_LICENCE_SEULE_MESSAGE') . "\n\n";
}
...
if ($helloasso === '0') {
    ...
    echo '1. ' . strip_tags(Text::sprintf('COM_GDA_ADHESION_POPUP_STEP1', CotisationService::getLabel($cotisationCode))) . "\n";
